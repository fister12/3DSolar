...
const torusTexture = new THREE.TextureLoader().load('fun.jpg');
const material = new THREE.MeshStandardMaterial({ map: torusTexture }); // Apply the texture to the material
